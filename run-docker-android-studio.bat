@echo off
REM MiauDX - Run Android Studio with Native GUI (without VNC) or Docker Web GUI
echo ====================================================
echo      MiauDX - Android Studio GUI Runner (Native)    
echo ====================================================
echo.
...
start "" wsl.exe -d Ubuntu env ANDROID_HOME=/opt/android-sdk PATH="/opt/android-sdk/platform-tools:/opt/android-sdk/cmdline-tools/latest/bin:$PATH" /opt/android-studio/bin/studio.sh /mnt/c/Users/JúlioAndrade/MiauDX
